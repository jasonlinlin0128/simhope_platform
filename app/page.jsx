...
const TESTIMONIALS = [
  {
    ...
    stars: 5,
    quote:
      "以前跟越南廠商溝通要靠翻譯軟體複製貼上，現在直接在系統裡翻譯，開會不再卡關，效率差很多！",
    name: "生產部領班",
    dept: "壓鑄機生產線",
    tool: "翻譯工具",
  },
  {
    ...
    stars: 5,
    quote:
      "合約這種東西以前要花很久看，用了 AI 審查之後，重點條款直接標出來，省了我至少一半時間。",
    name: "採購部同仁",
    dept: "國防零件採購",
    tool: "合約審查",
  },
  {
    ...
    stars: 5,
    quote:
      "工時日報以前都要手動整理 Excel，現在系統自動統計，月底不用再加班對資料了，大推！",
    name: "電控部主管",
    dept: "部門管理",
    tool: "工時日報系統",
  },
  {
    ...
    stars: 4,
    quote:
      "SOP 翻很久才找到答案，現在直接問文件問答庫，雖然偶爾還要再確認，但整體快很多。",
    name: "工程部工程師",
    dept: "國防工業專案",
    tool: "文件問答庫",
  },
