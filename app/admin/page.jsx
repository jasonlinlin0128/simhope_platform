                ...
                {activeTab === 'users' && (
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="bg-[var(--color-card-bg)] rounded-[24px] shadow-sm border border-[var(--color-card-border)] p-8">
                            ...
                            <form onSubmit={handleCreateDeveloper} className="flex flex-col gap-4 max-w-md">
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-xs font-extrabold text-[var(--color-text-mid)] uppercase tracking-wide">顯示名稱（選填）</label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-xs font-extrabold text-[var(--color-text-mid)] uppercase tracking-wide">電子郵件 *</label>
                                    <input
                                        type="email"
                                        value={newEmail}
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-xs font-extrabold text-[var(--color-text-mid)] uppercase tracking-wide">初始密碼 *（至少 6 碼）</label>
                                    <input
                                        type="password"
                                        value={newPassword}
                        ...
                        <div className="bg-[var(--color-card-bg)] rounded-[24px] shadow-sm border border-[var(--color-card-border)] p-8">
                            ...
                            <div className="flex flex-col gap-3">
                                {users.map(u => (
                                    <div key={u.id} className="flex flex-col md:flex-row justify-between items-center bg-[var(--color-card-bg)]/60 p-4 rounded-2xl border border-[var(--color-card-border)] gap-3">
                                        <div className="flex items-center gap-3 flex-1 w-full">
                                            ...
                                            <div>
                                                <div className="font-extrabold text-sm text-[var(--color-text-dark)]">{u.displayName || '(未設定名稱)'}</div>
                                        ...
                                        <div className="flex items-center gap-3 w-full md:w-auto">
                                            ...
                                            {u.id === user.uid && (
                                                <span className="text-xs text-gray-400 font-bold">(目前帳號)</span>
                                            )}
                                        </div>
                                    </div>
                                ))}
