...
export default function ChatbotWidget() {
  ...
  const send = async () => {
    ...
    setMessages((prev) => [
      ...
      {
        role: "bot",
        text: "感謝你的問題！目前 AI 回覆功能正在建置中，你可以先到「工具總覽」看看有沒有現成的工具，或寄信到 jasonlin@simhope.com.tw 提出需求。",
      },
    ]);
    setLoading(false);
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {open && (
        <div
          className="w-80 bg-white dark:bg-gray-900 rounded-2xl shadow-[0_16px_48px_rgba(0,0,0,0.18)] border border-gray-100 dark:border-gray-700 flex flex-col overflow-hidden"
