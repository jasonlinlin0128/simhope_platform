...
const DB = {
    ...
    DEFAULT_TOOLS: [
        ...
        {
            id: 't3', order: 2, color: 'c3',
            icon: '📅',
            title: '工時與日報系統',
            tagline: '取代 LINE 回報，月報自動生成',
            desc: '員工線上填寫每日工時與專案，主管即時查看所有人進度，系統自動統計月報，整個電控部都在用。',
            dept: 'mgmt',
            steps: ['填當日工作', '主管審核', '月報匯出'],
            status: 'live',
            url: '#',
            tags: ['工時', '日報', '管理'],
        },
        {
            id: 't4', order: 3, color: 'c4',
            icon: '🔍',
            title: '內部文件問答庫',
