...
const DB = {
    ...
    DEFAULT_TOOLS: [
        ...
        },
        {
            ...
            scenarios: ['技術傳承', '教育訓練'], steps: ['上傳文件', '輸入問題', '直接看答案'],
        ...
        },
        {
            ...
            scenarios: ['文書處理', '行銷支援'], steps: ['填入規格', '選擇語言', '下載草稿'],
        ...
        },
        {
            ...
            scenarios: ['品管檢驗'], steps: ['拍/上傳照片', 'AI 比對分析', '查看檢測報告'],
        ...
        // ── 已上線：下載 / 展示型 ──
        {
            ...
            scenarios: ['行政簽核'], steps: ['開啟工具', '選 PDF', '加簽後匯出'],
        ...
        },
        {
            ...
            scenarios: ['文書處理'], steps: ['上傳檔案', '自動偵測', '下載結果'],
        ...
        },
        {
            ...
            scenarios: ['檔案管理'], steps: ['開啟工具', '選目標檔案', '設定日期存檔'],
        ...
        },
        {
            ...
            scenarios: ['技術傳承', '內部平台'], steps: ['在 Teams 提問', 'AI 搜尋文件', '取得即時回答'],
        ...
        },
        {
            ...
            scenarios: ['文書處理'], steps: ['選檔案', '選目標格式', '下載轉檔結果'],
        ...
        // ── 待驗收 ──
        {
            ...
            scenarios: ['行政簽核'], steps: ['填出差申請', '主管審核', '總務確認'],
        ...
        // ── 開發中 ──
        {
            ...
            scenarios: ['機敏資料', '資安控管'], steps: ['正常使用影印機', '文件自動加浮水印', '浮水印含時間戳'],
        ...
        },
        {
            ...
            scenarios: ['生產現場', '報表轉換'], steps: ['在 MasterCAM 操作', '觸發外掛', '匯出客製報表'],
        ...
        },
        {
            ...
            scenarios: ['專案管理', '跨部門協作'], steps: ['登入行事曆', '新增或查看行程', '共享給同仁'],
        ...
        // ── 已終止 ──
        {
            ...
            scenarios: ['生產現場', '物管'], steps: ['掃描工單', '更新備料狀態', '產線即時獲知'],
